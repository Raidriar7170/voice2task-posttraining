# controlled-browser-demo-api Specification

## Purpose
Define the fail-closed provider, HTTP, WebSocket, sandbox, artifact, background-task, and public-sanitization interfaces for the localhost controlled browser demo.
