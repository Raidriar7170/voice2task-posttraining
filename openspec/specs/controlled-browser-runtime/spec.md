# controlled-browser-runtime Specification

## Purpose
Define the strict runtime contracts, durable state machine, capability-bound compilation, policy, confirmation, isolated execution, independent verification evidence, and controlled benchmark boundary for the browser demo.
