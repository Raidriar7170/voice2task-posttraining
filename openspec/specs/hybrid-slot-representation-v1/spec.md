# hybrid-slot-representation-v1 Specification

## Purpose
Define the design-only Hybrid Slot Representation V1 boundary for Voice2Task: internal field ownership, verifier-owned source spans/provenance, representation matrix, offline feasibility projection, and next-slice selection while BrowserTaskContract V1 remains the external schema.
