...
- Replace path-pattern redaction with an explicit public-result allowlist, bind filesystem identities for descriptor-relative output claims, require an idle A100 with at least 35 GiB free memory, prove prompt labels are fully masked from tokenizer offsets, and require measured adapter tensor changes before smoke completion.
