...
| BLOCKED | evaluate-frozen-copy-shadow-policy-on-template-disjoint-challenge-set | frozen public-safe template-disjoint challenge v1; no loadable frozen adapter identity | `CHALLENGE_EVALUATION_BLOCKED`; 120 rows frozen and template-disjoint audit passed, but observed challenge inference was not run. | - | `reports/public-sample/copy-shadow-template-disjoint-challenge-v1/challenge-summary.json` |
