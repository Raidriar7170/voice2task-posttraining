# A100 public held-out dev alignment diagnostics
...
- `normalized_command` (value_mismatch): gold string(6): 请求澄清目标; prediction string(4): 打开那个
...
- `normalized_command` (value_mismatch): gold string(6): 请求澄清目标; prediction string(6): 搜索公开信息
