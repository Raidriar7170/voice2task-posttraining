# Control test canonical slot paired SFT metrics
...
| metric | value |
| --- | ---: |
| `contract_exact_match_strict` | 0.758454 |
| `slot_value_exact_f1` | 0.795789 |
| `slot_value_normalized_f1` | 0.795789 |
| `executable_contract_pass_rate` | 0.792271 |
